        ...
        <div className="row">
          <div className="col-12">
            <div className="policy">
              ...
              <p className="bold">
                General Terms and Conditions of Use of the Marketplace for
                Buyers and Sellers
              </p>
              ...
              <ol>
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      {" "}
                      By using our marketplace, you accept these general terms
                      and conditions in full. If you disagree with these general
                      terms and conditions or any part of these general terms
                      and conditions, you must not use our marketplace.
                    </li>
                    <li>
                      {" "}
                      If you use our marketplace in the course of a business or
                      ...
                      <ol>
                        ...
                        <li>
                          {" "}
                          bind both yourself and the person, company or other
                          legal entity that operates that business or
                          organizational project, to these general terms and
                          conditions; and
                        </li>
                        <li>
                          {" "}
                          agree that "you" in these general terms and conditions
                          shall reference both the individual user and the
                          relevant person, company or legal entity unless the
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      You may not register with our marketplace if you are under
                      18 years of age (by using our marketplace or agreeing to
                      these general terms and conditions, you warrant and
                      represent to us that you are at least 18 years of age).
                    </li>
                    <li>
                      {" "}
                      If you register for an account with our marketplace, you
                      will be asked to provide an email address/user ID and
                      password and you agree to:
                      <ol>
                        <li> keep your password confidential;</li>
                        <li>
                          {" "}
                          notify us in writing immediately (using our contact
                          details provided at section 26) if you become aware of
                          any disclosure of your password; and
                        </li>
                        <li>
                          {" "}
                          be responsible for any activity on our marketplace
                          arising out of any failure to keep your password
                          confidential, and you acknowledge that you may be held
                    ...
                    <li>
                      {" "}
                      Your account shall be used exclusively by you and you
                    ...
                    <li>
                      ...
                      account details, at any time in our sole discretion and
                      without notice or explanation, providing that if we cancel
                      any products or services you have paid for but not
                      received, and you have not breached these general terms
                      and conditions, we will refund you in respect of the same.
                      See section 4.2 below for further information about
                      refunds.
                    </li>
                    <li>
                      {" "}
                      You may cancel your account on our marketplace by
                  ...
                  <ol>
                    <li>
                      ...
                      <ol>
                        <li>
                          {" "}
                          the marketplace provides an online location for
                        ...
                        <li>
                          ...
                          products will come into force between the buyer and
                          seller, and accordingly you commit to buying or
                          selling the relevant product or products, upon the
                          buyer's confirmation of purchase via the marketplace.
                        </li>
                      </ol>
                    </li>
                    <li>
                      {" "}
                      Subject to these general terms and conditions, the
                      seller's terms of business shall govern the contract for
                      sale and purchase between the buyer and the seller.
                      Notwithstanding this, the following provisions will be
                      incorporated into the contract of sale and purchase
                      between the buyer and the seller:
                      <ol>
                        <li>
                          {" "}
                          the price for a product will be as stated in the
                          relevant product listing;
                        </li>
                        <li>
                          {" "}
                          the price for the product must include all taxes and
                          comply with applicable laws in force from time to
                          time;
                        </li>
                        <li>
                          {" "}
                          delivery charges, packaging charges, handling charges,
                          administrative charges, insurance costs, other
                          ancillary costs and charges, where applicable, will
                          only be payable by the buyer if this is expressly and
                          clearly stated in the product listing; and delivery of
                          digital products may be made electronically;
                        </li>
                        <li>
                          {" "}
                          products must be of satisfactory quality, fit and safe
                          for any purpose specified in, and conform in all
                          material respects to, the product listing and any
                          other description of the products supplied or made
                          available by the seller to the buyer; and
                        </li>
                        <li>
                          {" "}
                          in respect of physical products sold, the seller
                          warrants that the seller has good title to, and is the
                          sole legal and beneficial owner of, the products
                          and/or has the right to supply the products pursuant
                          to this agreement, and that the products are not
                          subject to any third party rights or restrictions
                          including in respect of third party intellectual
                          property rights and/or any criminal, insolvency or tax
                          investigation or proceedings; and in respect of
                          digital products the seller warrants that the seller
                          has the right to supply the digital products to the
                          buyer.
                        </li>
                        <li>
                          {" "}
                          The Seller warrants that, where a product sold has
                          such terms, the Seller will provide detailed
                          disclosure of the product terms and conditions, any
                          applicable warranty, and other terms necessary to
                          inform the buyer on the product and its usage in the
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      ...
                      products by sellers shall be managed by us in accordance
                      with the returns page on the marketplace, as may be
                      amended from time to time. Acceptance of returns shall be
                      in our discretion, subject to compliance with applicable
                      laws of the territory.
                    </li>
                    <li>
                      {" "}
                      Refunds in respect of returned products shall be managed
                      in accordance with the refunds page on the marketplace, as
                      may be amended from time to time. Our rules on refunds
                      shall be exercised in our discretion, subject to
                      applicable laws of the territory. We may offer refunds, in
                      our discretion:
                      <ol>
                        <li> in respect of the product price;</li>
                        <li>
                          {" "}
                          in respect of local and/or international shipping fees
                          (as stated on the refunds page); and
                        </li>
                        <li>
                          {" "}
                          by way of store credits, vouchers, mobile money
                          transfer, bank transfers or such other methods as we
                    ...
                    <li>
                      {" "}
                      Changes to our returns page or refunds page shall be
                      effective in respect of all purchases made from the date
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      In these general terms and conditions, "your content"
                      means:
                      <ol>
                        <li>
                          {" "}
                          ...
                          files) that you submit to us or our marketplace for
                          storage or publication, processing by, or onward
                          transmission; and
                        </li>
                        <li>
                          {" "}
                          all communications on the marketplace, including
                    ...
                    <li>
                      ...
                      accordance with these general terms and conditions, must
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          {" "}
                          be blasphemous, in breach of racial or religious
                          hatred or discrimination legislation;
                        </li>
                        <li>
                          {" "}
                          be deceptive, fraudulent, threatening, abusive,
                          harassing, anti-social, menacing, hateful,
                          discriminatory or inflammatory;
                        </li>
                        <li>
                          {" "}
                          cause annoyance, inconvenience or needless anxiety to
                          any person; or
                        </li>
                    ...
                    <li>
                      ...
                      person's legal rights, or be capable of giving rise to
                      legal action against any person (in each case in any
                      jurisdiction and under any applicable law). Your content
                      must not infringe or breach:
                      <ol>
                        <li>
                          {" "}
                          any copyright, moral right, database right, trademark
                    ...
                    <li>
                      {" "}
                      You must not use our marketplace to link to any website or
                      web page consisting of or containing material that would,
                      were it posted on our marketplace, breach the provisions
                      of these general terms and conditions.
                    </li>
                    <li>
                      {" "}
                      You must not submit to our marketplace any material that
                    ...
                    <li>
                      ...
                      facilitate buyer reviews on products. You shall not use
                      the review function or any other form of communication to
                      provide inaccurate, inauthentic or fake reviews.
                    </li>
                    <li>
                      {" "}
                      You must not interfere with a transaction by: (i)
                      contacting another user to buy or sell an item listed on
                      the marketplace outside of the marketplace; or (ii)
                      communicating with a user involved in an active or
                      completed transaction to warn them away from a particular
                      buyer, seller or item; or (iii) contacting another user
                      with the intent to collect any payments.
                    </li>
                    <li>
                      {" "}
                      You acknowledge that all users of the marketplace are
                      solely responsible for interactions with other users and
                      you shall exercise caution and good judgment in your
                      communication with users. You shall not send them personal
                      information including credit card details.
                    </li>
                    <li>
                      {" "}
                      We may periodically review your content and we reserve the
                      right to remove any content in our discretion for any
                      reason whatsoever.
                    </li>
                    <li>
                      {" "}
                      If you learn of any unlawful material or activity on our
                      marketplace, or any material or activity that breaches
                      these general terms and conditions, you may inform us by
                      contacting us as provided at section 26.
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol>
                    <li>
                      ...
                      royalty-free license to use, reproduce, store, adapt,
                      publish, translate and distribute your content on our
                      marketplace, and across our marketing channels and any
                    ...
                    <li>
                      ...
                      terms and conditions, if you breach our rules on content
                      in any way, or if we reasonably suspect that you have
                      breached our rules on content, we may delete, unpublish or
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          ...
                          non-commercial use, providing that such printing is
                          not systematic or excessive;
                        </li>
                        <li>
                          {" "}
                          stream audio and video files from our website using
                          the media player on our website; and
                        </li>
                        <li>
                          {" "}
                          use our marketplace services by means of a web
                          browser,
                        </li>
                      </ol>
                    ...
                    <li>
                      ...
                      provisions of these general terms and conditions, you must
                      not download any material from our website or save any
                      such material to your computer.
                    </li>
                    <li>
                      {" "}
                      You may only use our website for your own personal and
                      business purposes in respect of selling or purchasing
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          {" "}
                          republish material from our website (including
                    ...
                    <li>
                      {" "}
                      Notwithstanding section 10.6, you may forward links to
                      products on our website and redistribute our newsletter
                      and promotional materials in print and electronic form to
                      any person.
                    </li>
                    <li>
                      {" "}
                      ...
                      upon our website. We may, for example, suspend access to
                      the website during server maintenance or when we update
                      the website. You must not circumvent or bypass, or attempt
                      to circumvent or bypass, any access restriction measures
                      on the website.
                    </li>
                    <li>
                      {" "}
                      ...
                      <ol>
                        <li>
                          ...
                          impairment of the performance, availability,
                          accessibility, integrity or security of the website;
                        </li>
                        <li>
                          {" "}
                          use our website in any way that is unethical,
                        ...
                        <li>
                          {" "}
                          decrypt or decipher any communications sent by or to
                        ...
                        <li>
                          ...
                          any robot, spider or other automated means, except for
                          the purpose of search engine indexing;
                        </li>
                        <li>
                          {" "}
                          use our website except by means of our public
                          interfaces;
                        </li>
                        <li>
                          {" "}
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      Subject to the express provisions of these general terms
                      and conditions:
                      <ol>
                        <li>
                          {" "}
                    ...
                    <li>
                      ...
                      respective owners and we do not endorse and are not
                      affiliated with any of the holders of any such rights and
                      as such we cannot grant any license to exercise such
                      rights.
                    </li>
                  </ol>
                </li>
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      We operate an anti-fraud and anti-money laundering
                      compliance program and reserve the right to perform due
                      diligence checks on all users of the marketplace.
                    </li>
                    <li>
                      {" "}
                      You agree to provide to us all such information,
                      documentation and access to your business premises as we
                      may require:
                      <ol>
                        <li>
                          {" "}
                          in order to verify your adherence to, and performance
                          of, your obligations under these terms and conditions;
                        </li>
                        <li>
                          {" "}
                          for the purpose of disclosures pursuant to a valid
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          {" "}
                          the relevant seller warrants and represents the
                          completeness and accuracy of their information
                          published on our marketplace relating to their
                          products;
                        </li>
                        <li>
                          {" "}
                    ...
                    <li>
                      ...
                      for war; epidemics or pandemics; or extra-constitutional
                      events or circumstances which materially and adversely
                      affect the political or macro-economic stability of the
                    ...
                    <li>
                      ...
                      marketplace, at any time in our sole discretion without
                      notice or explanation; and you will not be entitled to any
                    ...
                    <li>
                      {" "}
                      If we discontinue or alter any or all of our marketplace
                      in circumstances not relating to force majeure, we will
                    ...
                    <li>
                      {" "}
                      We do not guarantee any commercial results concerning the
                      use of the marketplace.
                    </li>
                    <li>
                      {" "}
                      To the maximum extent permitted by applicable law and
                      subject to section 15.1 below, we exclude all
                      representations and warranties relating to the subject
                      matter of these general terms and conditions, our
                  ...
                  <ol>
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          {" "}
                          exclude any liabilities or statutory rights that may
                    ...
                    <li>
                      ...
                      this section 15 and elsewhere in these general terms and
                      conditions:
                      <ol>
                        <li> are subject to section 15.1; and</li>
                        <li>
                          {" "}
                          govern all liabilities arising under these general
                          terms and conditions or relating to the subject matter
                          of these general terms and conditions, including
                    ...
                    <li>
                      {" "}
                      In respect of the services offered to you free of charge
                      we will not be liable to you for any loss or damage of any
                      nature whatsoever.
                    </li>
                    <li>
                      {" "}
                      Our aggregate liability to you in respect of any contract
                      to provide services to you under these general terms and
                      conditions shall not exceed the total amount paid and
                      payable to us under the contract. Each separate
                      transaction on the marketplace shall constitute a separate
                      contract for the purpose of this section 15.4.
                    </li>
                    <li>
                      {" "}
                      Notwithstanding section 15.4 above, we will not be liable
                      to you for any loss or damage of any nature, including in
                      respect of:
                      <ol>
                        <li>
                          {" "}
                          any losses occasioned by any interruption or
                          dysfunction to the website;
                        </li>
                        <li>
                          {" "}
                          any losses arising out of any event or events beyond
                          our reasonable control;
                        </li>
                        <li>
                          {" "}
                          any business losses, including (without limitation)
                          loss of or damage to profits, income, revenue, use,
                          production, anticipated savings, business, contracts,
                          commercial opportunities or goodwill;
                        </li>
                        <li>
                          {" "}
                          any loss or corruption of any data, database or
                          software; or
                        </li>
                        <li>
                          {" "}
                    ...
                    <li>
                      {" "}
                      We accept that we have an interest in limiting the
                      ...
                      conditions (this will not limit or exclude the liability
                    ...
                    <li>
                      {" "}
                      Our marketplace includes hyperlinks to other websites
                      owned and operated by third parties; such hyperlinks are
                      not recommendations. We have no control over third party
                      websites and their contents, and we accept no
                  ...
                  <ol>
                    <li>
                      ...
                      <ol>
                        <li>
                          {" "}
                          any and all losses, damages, costs, liabilities and
                          expenses (including without limitation legal expenses
                          and any amounts paid by us to any third party in
                          settlement of a claim or dispute) incurred or suffered
                        ...
                        <li>
                          {" "}
                          any VAT liability or other tax liability that we may
                          incur in relation to any sale, supply or purchase made
                          through our marketplace, where that liability arises
                          out of your failure to pay, withhold, declare or
                          register to pay any VAT or other tax properly due in
                          any jurisdiction.
                        </li>
                      </ol>
                    </li>
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      If we permit the registration of an account on our
                      marketplace it will remain open indefinitely, subject to
                    ...
                    <li>
                      ...
                      <ol>
                        ...
                        <li>
                          {" "}
                          suspend or delete your account on our marketplace;
                          and/or
                        </li>
                        <li>
                          {" "}
                    ...
                    <li>
                      ...
                      marketplace or a part of our marketplace you must not take
                      any action to circumvent such suspension or prohibition or
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      {" "}
                      The revised general terms and conditions shall apply from
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      ...
                      continuing waiver of any other breach of that provision or
                      any breach of any other provision of these general terms
                      and conditions.
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      general terms and conditions would be lawful or
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      A contract under these general terms and conditions is for
                      our benefit and your benefit, and is not intended to
                ...
                <li>
                  ...
                  <ol>
                    <li>
                      {" "}
                      These general terms and conditions shall be governed by
                    ...
                    <li>
                      ...
                      conditions shall be subject to the exclusive jurisdiction
                      of the courts of the territory.
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      {" "}
                      You consent to receive notices electronically from us. We
                      may provide all communications and information related to
                      your use of the marketplace in electronic format, either
                      by posting to our website or application, or by email to
                      the email address on your account. All such communications
                      will be deemed to be notices in writing and received by
                      and properly given to you.
                    </li>
                  </ol>
                </li>
              </ol>
